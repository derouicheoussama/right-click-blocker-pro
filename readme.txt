...
= 2.26.1 =
* Fix: PHP warnings on the License page email journal when older log entries lack fields introduced later (e.g. "type") — all journal columns now read defensively and unknown types display a neutral label.
